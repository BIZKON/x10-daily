  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <Field
        ...
        help={
          <>
            Подпись под именем в статье — она объясняет читателю, почему этому человеку стоит
            верить. Её видят все.
            <br />
            <br />
            ⚠️ Это <b>не права доступа</b>. Что человек может делать в кабинете — публиковать,
            править, только смотреть — задаётся отдельно, в разделе «Команда». Написать здесь
            «Главный редактор» не значит выдать права редактора.
          </>
        }
      >
