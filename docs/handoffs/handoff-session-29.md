...
**Дата:** 2026-07-25 · сессия закрыта
**Локальный HEAD:** `361b6b7` · **origin/main:** `987d0c5` (⚠️ **ahead 3, НЕ запушено**)
...
> и спросить владельца про push незапушенных коммитов. Все три инертны: пока
> `COVERS_PUBLIC_BASE_URL` пуст, генерация обложек выключена, поведение прода не меняется.
