...
- 🔴 На сайте бывает ЧУЖОЕ: новости об отрасли, кейсы других компаний, цены чужих сервисов, цитаты и обзоры. База знаний — только о самой компании и её собственных услугах, работах и ценах. Чужое не предлагай ни на одну полку, даже если оно лежит в разделе с подходящим названием: раздел «Кейсы» на сайте-медиа может быть рассказом о чужих проектах, а полка «Кейсы» спрашивает, что сделала САМА компания.
- Если сомневаешься, о компании этот материал или нет, — не создавай документ, а напиши об этом в notes. Оговорка внутри документа не спасает: человек увидит его кнопкой «принять» и примет.
